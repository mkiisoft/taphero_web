define(['dart_sdk'], function(dart_sdk) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["org-dartlang-app:///packages/vector_math/hash.dart"],"names":[],"mappings":";;;;;;;;;;8BAOiC;AAC7B,wBAAQ,AAAQ,OAAD,kBAAW,GAAG,SAAK,GAAU,MAAM,cAAS,CAAC,EAAI,cAAF,CAAC;EAAY;2BAG9D,MAAU;IACzB,OAAO,AAAW,YAAQ,aAAL,IAAI,iBAAG,KAAK;IACjC,OAAO,AAAW,YAAQ,aAAL,IAAI,KAAwB,CAAnB,AAAW,sBAAE,IAAI,MAAK;AACpD,UAAY,eAAL,IAAI,IAAI,AAAK,IAAD,cAAI;EACzB;0BAEgB;IACd,OAAO,AAAW,YAAQ,aAAL,IAAI,KAAwB,CAAnB,AAAW,wBAAE,IAAI,MAAK;IACpD,OAAY,cAAL,IAAI,IAAI,AAAK,IAAD,cAAI;AACvB,UAAO,AAAW,aAAQ,aAAL,IAAI,KAAwB,CAAnB,AAAW,qBAAE,IAAI,MAAK;EACtD","file":"hash.ddc.js"}');
  // Exports:
  return {
    hash: hash
  };
